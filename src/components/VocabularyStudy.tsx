                ...
                >
                  ...
                  >
                    ...
                    <div className="flex-1 flex flex-col items-center justify-center relative z-10 text-center px-6">
                      ...
                      <motion.h2
                        layout
                        className={`${studyMode === 'mastery' ? 'text-[clamp(2.2rem,8vw,3.5rem)]' : 'text-[clamp(2rem,10vw,4.5rem)] jp-text'} font-black bg-gradient-to-br from-white to-white/60 bg-clip-text text-transparent mb-2 leading-relaxed h-auto`}
                      >
                        {studyMode === 'mastery' ? (
                          currentItem.meaning
                        ) : (
                  ...
                  >
                    ...
                    <div className="flex-1 flex flex-col items-center justify-center text-center">
                      <motion.h3
                        ...
                        className={`${studyMode === 'mastery' ? 'text-[clamp(2rem,10vw,5rem)]' : 'text-[clamp(2.2rem,8vw,3.5rem)]'} font-black mb-4 jp-text text-white leading-relaxed`}
                      >
                        {studyMode === 'mastery' ? (
                          <FuriganaText
                            text={`${currentItem.kanji || currentItem.furigana}${currentItem.kanji && currentItem.kanji !== currentItem.furigana ? `[${currentItem.furigana}]` : ''}`}
